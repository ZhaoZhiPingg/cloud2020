...
public class SnowflakeIdWorker1 {
    ...
    static {
        idWorker = new SnowflakeIdWorker1(1);
    }
...
//    private static final long twepoch = 315504000000L;
     ...
     */
    private SnowflakeIdWorker1(long workerId) {
        this(workerId,0);
    }
    /**
     * 构造函数
     ...
     */
    private SnowflakeIdWorker1(long workerId, long datacenterId) {
    ...
    public static void main(String[] args) {
        for (int i = 0; i < 100; i++) {
            long id = SnowflakeIdWorker1.getId();
            String strId = SnowflakeIdWorker1.getRandomStr();

            System.out.println(id);
            System.out.println(strId);
            System.out.println(SnowflakeIdWorker1.getTime(id));
        }
    }
